...
public class ByteCodeDetailPane extends AbstractDetailPane {
    ...
    public void show(TreePath treePath) {
        ...
        codeAttribute = (CodeAttribute)findAttribute(treePath);
        if (byteCodeDisplay.getCodeAttribute() != codeAttribute) {
            ...
            byteCodeDisplay.setCodeAttribute(codeAttribute, services.getClassFile());
   ...
   public int getFirstLineNumber() {
      return byteCodeDisplay.getFirstLineNumber();
   }

   public int getLastLineNumber() {
      return byteCodeDisplay.getLastLineNumber();
   }
