...
public class ConstantPoolDetailPane extends AbstractDetailPane {
    ...
    private static final String SCREEN_CONSTANT_METHOD_HANDLE_INFO = "ConstantMethodHandleInfo";
    private static final String SCREEN_CONSTANT_INVOKE_DYNAMIC_INFO = "ConstantInvokeDynamicInfo";
    ...
    protected void setupComponent() {
       ...
       addScreen(new ConstantMethodHandleDetailPane(services),
          SCREEN_CONSTANT_METHOD_HANDLE_INFO);

       addScreen(new ConstantInvokeDynamicInfoDetailPane(services),
          SCREEN_CONSTANT_INVOKE_DYNAMIC_INFO);
    }
    ...
    public void show(TreePath treePath) {
        ...
        if (constantPoolEntry instanceof ConstantUtf8Info) {
            ...
            paneName = SCREEN_CONSTANT_METHOD_HANDLE_INFO;
        } else if (constantPoolEntry instanceof ConstantInvokeDynamicInfo) {
            paneName = SCREEN_CONSTANT_INVOKE_DYNAMIC_INFO;
        }
